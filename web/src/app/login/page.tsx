        ...
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white/40 backdrop-blur-sm border border-black/[0.06] rounded-2xl p-6 sm:p-8 text-center space-y-4">
            ...
            <p className="text-black/35 text-sm leading-relaxed">
              ...
              <span className="text-[#0A0A0A]">{email}</span>, we&apos;ve sent a
              one-time sign-in link. it expires shortly.
            </p>
            <button
              type="button"
              onClick={() => {
          ...
          >
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="email" className="font-display text-[11px] tracking-wide text-black/25 block">
                  email
                </label>
                <input
                  id="email"
              ...
              {mode === "password" && (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <label htmlFor="password" className="font-display text-[11px] tracking-wide text-black/25 block">
                      password
                    </label>
                    <Link
