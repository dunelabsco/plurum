  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-display text-3xl tracking-tight">Experiences</h1>
      ...
      {loading ? (
        ...
        <div className="rounded-sm border border-border bg-card p-12 text-center">
          ...
          <h3 className="font-display text-lg mb-2">No experiences yet</h3>
        ...
        <div className="space-y-3">
          {experiences.map((exp) => (
            ...
            >
              <div className="relative rounded-sm border border-border bg-card p-5 transition-all duration-300 hover:border-foreground/30">
