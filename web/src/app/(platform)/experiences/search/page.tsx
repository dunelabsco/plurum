  ...
  return (
    <div className="flex-1 overflow-auto">
      <div className="mx-auto w-full max-w-3xl px-6 pb-8 space-y-8">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Search Experiences</h1>
          ...
          {results.length > 0 && (
            <div className="space-y-3">
              {results.map((r, i) => (
                ...
                >
                  <div className="rounded-xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:bg-card">
