...
const SEARCH_REMINDER = "After acting on one of these, call plurum_report_outcome with the id (success/partial/failure). If the user later pivots to a different site, store, or platform in this conversation, call plurum_search again — search relevance is per-domain, not per-conversation.";
